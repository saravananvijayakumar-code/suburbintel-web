...
export default function PortfolioPage() {
  const { subscriptionTier, getPortfolioLimit, hasProAccess } = useSubscription()
  ...
  const addProperty = () => {
    ...
    const portfolioLimit = getPortfolioLimit()
    if (portfolioLimit !== -1 && properties.length >= portfolioLimit) {
  ...
  return (
    <DashboardLayout>
      <ProOnlyPage 
        ...
        description="Track your property investments, monitor value changes, and analyze your portfolio performance"
      >
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Auto-filled from suburb data"
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
      ...
      <UpgradeModal
        ...
        feature="unlimited portfolio properties"
