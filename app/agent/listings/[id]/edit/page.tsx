...
export default function EditListingPage() {
  ...
  const fetchListing = async () => {
    try {
      const response = await fetch(`/api/properties/listings/${params.id}`)
      if (response.ok) {
        ...
        setFormData({
          ...
          weeklyRent: listing.weeklyRent?.toString() || '',
          bedrooms: listing.bedrooms?.toString() || '',
          bathrooms: listing.bathrooms?.toString() || '',
          carSpaces: listing.carSpaces?.toString() || '',
          landSize: listing.landSize?.toString() || '',
          buildingSize: listing.buildingSize?.toString() || '',
